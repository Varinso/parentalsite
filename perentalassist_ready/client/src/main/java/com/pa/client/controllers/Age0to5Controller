...
public class Age0to5Controller {
    ...
    public void initialize() {
        URL heroUrl = getClass().getResource("/images/age0to5.jpg");
        ...
        items.add(new VideoItem("Advice for parents or carers of children aged 0-5 years", "https://youtu.be/L815TFFMlLM?si=-0ZlXujHWVEDXbau"));
        items.add(new VideoItem("How Every Child Can Thrive by Five | Molly Wright | TED", "https://youtu.be/aISXCw0Pi94?si=H9BqBGuWjvVBKLe7"));
        items.add(new VideoItem("Learn how to boost your baby's brain from a Harvard Professor | UNICEF", "https://youtu.be/fpiYNkkNmEo?si=S3KKGGRU0a68VOOL"));
        buildGallery(items);
    }
